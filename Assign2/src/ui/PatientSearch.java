...
public class PatientSearch extends javax.swing.JFrame {
   ...
   CommunityDirectory communityHistory;
    ...
    HospitalDirDirectory hospitalDirHistory,DoctorDirectory doctorHistory,EncounterHistory encounterHistory) {
        initComponents();
    ...
    private void selectbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectbtnActionPerformed
        ...
        if (selectedRowIndex<0){
          ...
          AppointmentJFrame a=new AppointmentJFrame( personHistory, patientHistory, houseHistory,communityHistory,   cityHistory, hospitalHistory, hospitalDirHistory,doctorHistory,encounterHistory);
