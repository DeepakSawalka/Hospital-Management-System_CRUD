...
public class HouseJPanel extends javax.swing.JPanel {
    ...
    public HouseJPanel(CommunityDirectoryH communityHistoryH,CommunityDirectoryHos communityHistoryHos) {
        initComponents();
    ...
    private void housedetailstblhMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_housedetailstblhMouseClicked
        ...
        if (selectedRowIndex<0){
          ...
          CommunityH selectedCommunityH=(CommunityH ) model.getValueAt(selectedRowIndex, 0);
    ...
    private void deletebtnhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnhActionPerformed
        ...
        if (i<0){
          ...
          DefaultTableModel model=(DefaultTableModel) housedetailstblh.getModel();
          CommunityH selectedCommunity=(CommunityH) model.getValueAt(i, 0);
    ...
    private void populateTableCommH() {
        DefaultTableModel model=(DefaultTableModel) housedetailstblh.getModel();
        model.setRowCount(0);
        
        for (CommunityH ch : communityHistoryH.getCommunityHistoryH())
        {
