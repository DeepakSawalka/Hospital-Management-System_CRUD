...
public class SystemJFrame extends javax.swing.JFrame {
    ...
    private void persondetailsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_persondetailsbtnActionPerformed
        ...
        dispose();
        PersonDirectoryJFrame personDirectoryJFrame=new PersonDirectoryJFrame(personHistory, patientHistory,houseHistory,communityHistory,cityHistory,hospitalHistory,hospitalDirHistory,doctorHistory,encounterHistory);
    ...
    private void patientdetailsbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_patientdetailsbtnActionPerformed
        // TODO add your handling code here:
        dispose();
        PatientDirectoryJFrame patientDirectoryJFrame=new PatientDirectoryJFrame(personHistory, patientHistory,houseHistory,communityHistory,cityHistory,hospitalHistory,hospitalDirHistory,doctorHistory,encounterHistory);
    ...
    private void citybtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_citybtnActionPerformed
        // TODO add your handling code here:
        dispose();
        CitySystemJFrame cityAdminJFrame=new CitySystemJFrame(personHistory, patientHistory,houseHistory,communityHistory,cityHistory,hospitalHistory,hospitalDirHistory,doctorHistory,encounterHistory);
    ...
    private void hospitalbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hospitalbtnActionPerformed
        // TODO add your handling code here:
        dispose();
        HospitalAdminJFrame hospitalAdminJFrame=new HospitalAdminJFrame(personHistory, patientHistory,houseHistory,communityHistory,cityHistory,hospitalHistory,hospitalDirHistory,doctorHistory,encounterHistory);
